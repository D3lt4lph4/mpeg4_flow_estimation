...
class GeneratorMVSecond(BaseGenerator):
    ...
    def __getitem__(self, index):
        ...
        for data_file in data_files:
            rgb_path.append(data_file.replace("compressed_data", "rgb_data").replace("mv_qtv_data.hdf5", "rgb_data.mp4"))
        ...
        return {"data_input": np.array(X), "rgb_path": rgb_path},  {"predictions": np.array(Y)}
